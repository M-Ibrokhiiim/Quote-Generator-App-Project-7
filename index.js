...
const authorPlace=document.getElementById('quoteAuthor')

function quotesFunction() {
 const quote=quotes[Math.floor(Math.random()*quotes.length)]
 
 quotePlace.textContent=quote.quote
 authorPlace.textContent=quote.author
 return
}


function tweetFunction(){
    window.open(`https://twitter.com/intent/tweet?text=${quotePlace.textContent} +" " +-by ${ authorPlace.textContent}`)
}
